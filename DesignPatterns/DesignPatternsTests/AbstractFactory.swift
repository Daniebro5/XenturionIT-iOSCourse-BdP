...
protocol AbstractCama {
    func dormir()
}

class CamaVictoriana: AbstractCama {
    func dormir() {
        print("Estoy durmiendo en una cama victoriana")
    }
}

class CamaModerna: AbstractCama {
    func dormir() {
        print("Estoy durmiendo en una cama moderna")
    }
    
    func encenderLampara() {
